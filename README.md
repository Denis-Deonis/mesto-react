...
#  Проектная работа: Место на «React» <img src="https://raw.githubusercontent.com/Denis-Deonis/pictures/main/mesto/reactIcon.gif" width="28px" height="28px" alt="React"> . <br> Реализована в рамках учебной и практической работы на платформе [Яндекс.Практикум](https://praktikum.yandex.ru/) в факультете ["Веб-разработчик"](https://praktikum.yandex.ru/web/)
